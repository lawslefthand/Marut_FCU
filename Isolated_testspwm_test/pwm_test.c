...
/*
 ...
 duty_1 = ((float)HAL_TIM_ReadCapturedValue(htim, TIM_CHANNEL_2) *100)/ICValue_1;



 frequency_1 = 16000000/ICValue_1;

 pulse_width_us = (duty_1 * 1000000.0f) / (100.0f * (float)frequency_1);
 }
 }
 }
 }
...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
		...
		printf("CH1:%f CH2:%f CH3:%f CH4:%f\n",pulse_width_us_1,pulse_width_us_2,pulse_width_us_3,pulse_width_us_4);
		HAL_Delay(100);
    /* USER CODE END WHILE */
