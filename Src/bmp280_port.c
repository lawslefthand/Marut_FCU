...
void bmp_hal_i2c_write(uint8_t reg_addr, uint8_t value) {
    ...
    HAL_I2C_Mem_Write(&hi2c1, BMP280_I2C_ADDR, reg_addr, I2C_MEMADD_SIZE_8BIT, &data_to_write, 1, HAL_MAX_DELAY);
}


uint8_t bmp_hal_i2c_read(uint8_t reg_addr) {
    uint8_t read_value = 0;
    HAL_I2C_Mem_Read(&hi2c1, BMP280_I2C_ADDR, reg_addr, I2C_MEMADD_SIZE_8BIT, &read_value, 1, HAL_MAX_DELAY);
    return read_value;
}
